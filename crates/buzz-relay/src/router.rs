...
pub fn build_router(state: Arc<AppState>) -> Router {
    ...
    let airhop_agents_router = Router::new()
        ...
        .route(
            ...
            post(api::airhop_agents::prepare_agent_action),
        )
        .layer(RequestBodyLimitLayer::new(16 * 1024))
        .with_state(state.clone());
    ...
    let airhop_staff_router = Router::new()
        ...
        .route(
            "/api/airhop/staff/v1/teachers",
            get(api::airhop_staff::list_teachers).post(api::airhop_staff::create_teacher),
        )
        .route(
            "/api/airhop/staff/v1/teachers/{teacher_id}",
            put(api::airhop_staff::put_teacher),
        )
        .route(
            "/api/airhop/staff/v1/payments",
            get(api::airhop_staff::list_payments),
        )
        .route(
            "/api/airhop/staff/v1/payments/{payment_id}",
        ...
        .route(
            "/api/airhop/staff/v1/branches/{branch_id}/rooms",
            post(api::airhop_staff::create_room),
        )
        .route(
            "/api/airhop/staff/v1/branches/{branch_id}/rooms/{room_id}",
        ...
        .route(
            "/api/airhop/staff/v1/lessons/{recurrence_rule_id}/{original_date}/participants",
            get(api::airhop_staff::get_lesson_roster)
                .post(api::airhop_staff::add_lesson_participant),
        )
        .route(
        ...
        .route(
            "/api/airhop/staff/v1/enrollments",
            post(api::airhop_staff::enroll_staff_participant),
        )
        .route(
            "/api/airhop/staff/v1/enrollments/{enrollment_id}",
            put(api::airhop_staff::mutate_enrollment),
        )
        .route(
        ...
        .route(
            ...
            get(api::airhop_staff::get_family_detail).put(api::airhop_staff::update_family),
        )
        .route(
            "/api/airhop/staff/v1/families/{family_id}/children",
            post(api::airhop_staff::add_family_child),
        )
        .route(
        ...
        .route(
            "/api/airhop/staff/v1/families/{family_id}/children/{child_id}/status",
            put(api::airhop_staff::set_family_child_status),
        )
        .route(
        ...
        .route(
            ...
            put(api::airhop_staff::set_family_representative_status),
        )
        .route(
        ...
        .route(
            ...
            post(api::airhop_channel_gateway::connect_whatsapp_cloud),
        )
        .route(
            "/api/airhop/integrations/v1/channel-connections/{connection_id}/whatsapp-cloud/activate",
