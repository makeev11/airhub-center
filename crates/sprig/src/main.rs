...
fn dispatch() -> Result<(), String> {
    ...
    match cmd.as_str() {
        ...
        // buzz-dev-mcp also handles its own multicall names: airhop-agent-mcp,
        // rg, tree, buzz, git-credential-nostr, and git-sign-nostr.
