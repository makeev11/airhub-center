...
export const ptBrPaymentMessages: BookingPaymentMessages = {
  paymentsBuzzChannel: "Canal de pagamentos",
  paymentsBuzzChannelHint:
    "Uma conversa mensal com alterações em pagamentos vencidos aparecerá neste canal.",
  paymentsBuzzChannelNone: "Não publicar resumos",
  analyticsBuzzChannel: "Canal de análises",
  analyticsBuzzChannelHint:
    "Uma conversa mensal separada sobre pagamentos e funil aparecerá aqui e será atualizada somente quando os dados mudarem.",
  analyticsBuzzChannelNone: "Não publicar análises",
  paymentExpected: "Previsto",
  paymentOverdue: "Vencido",
  paymentPaid: "Pago",
  paymentCancelled: "Cancelado",
  paymentDueSummary: (amount, date) => `Vencimento ${amount} · ${date}`,
  paymentsTitle: "Pagamentos",
  paymentsDescription:
    "Fila de trabalho dos pagamentos previstos e histórico das decisões da equipe.",
  analyticsTitle: "Análises",
  analyticsDescription:
    "Do primeiro contato ao aluno regular: presença, capacidade e fluxo de caixa.",
  analyticsAsOf: (date) => `Dados em ${date}`,
  analyticsPaidThisMonth: "Pago neste mês",
  analyticsOutstandingThisMonth: "Pendente neste mês",
  analyticsOpenTotal: (amount, count) =>
    `Total em aberto: ${amount} · ${count}`,
  analyticsOverdueTotal: "Total vencido",
  analyticsPaidShare: "Percentual pago",
  analyticsPaidShareHint: "Das cobranças não canceladas do mês atual",
  analyticsTrendTitle: "Evolução em seis meses",
  analyticsTrendDescription:
    "O mês de cobrança não muda quando o vencimento de um pagamento é alterado.",
  analyticsScheduled: "Cobrado",
  analyticsPaymentsCount: (count) =>
    `${count} ${count === 1 ? "pagamento" : "pagamentos"}`,
  analyticsNoDataTitle: "Ainda não há dados para análise",
  analyticsNoDataDescription:
    "Os indicadores aparecerão depois que o primeiro pagamento previsto for criado.",
  analyticsPaymentsTab: "Pagamentos",
  analyticsFunnelTab: "Funil",
  funnelAsOf: (date) => `Coortes em ${date}`,
  funnelCohort: "Mês da solicitação",
  funnelSource: "Origem",
  funnelBranch: "Unidade",
  funnelAllSources: "Todas as origens",
  funnelAllBranches: "Todas as unidades",
  funnelTrialBookings: "Solicitações de aula experimental",
  funnelConfirmedTrials: "Experimental confirmada",
  funnelAttendedTrials: "Experimental realizada",
  funnelPermanentEnrollments: "Matrícula permanente",
  funnelFirstPaymentsPaid: "Primeiro pagamento",
  funnelShareOfCohort: "das solicitações desta coorte",
  funnelFirstPaymentAmount: "Valor do primeiro pagamento",
  funnelTrendTitle: "Coortes de seis meses",
  funnelTrendDescription:
    "Cada linha mostra o caminho da solicitação até o primeiro pagamento.",
  funnelNoDataTitle: "Nenhuma solicitação experimental nesta coorte",
  funnelNoDataDescription:
    "Escolha outro mês, origem ou unidade, ou aguarde novas solicitações.",
  funnelSourceLabel: (channel) =>
    ({
      website: "Site",
      phone: "Telefone",
  ...
  paymentFilterOpen: "A pagar",
  paymentFilterPaid: "Pago",
  paymentFilterCancelled: "Cancelado",
  paymentSearch: "Buscar criança, família, grupo ou plano",
  paymentNoOpenTitle: "Nenhum pagamento previsto",
  paymentNoOpenDescription:
    "Novos pagamentos aparecem depois de uma matrícula em grupo.",
  paymentNoHistoryTitle: "Nada aqui ainda",
  paymentNoHistoryDescription:
    "Os pagamentos com o status selecionado aparecerão aqui.",
  paymentFamily: "Família",
  paymentTariff: "Plano",
  paymentGroup: "Grupo",
  paymentDueDate: "Data de vencimento",
  paymentAmount: "Valor",
  paymentReceived: "Recebido",
  paymentOutstanding: "Pendente",
  paymentHistory: "Histórico de transações",
  paymentReceipt: "Pagamento",
  paymentRefund: "Estorno",
  paymentRefundAction: "Fazer estorno",
  ...
  paymentNote: "Observação (opcional)",
  paymentNotePlaceholder: "Por exemplo, número da transferência ou comentário",
  paymentRefundSuccess: "Estorno registrado",
  paymentMarkPaid: "Confirmar pagamento",
  paymentChangeAmount: "Alterar valor",
  paymentMoveDueDate: "Alterar vencimento",
  paymentCancel: "Cancelar cobrança",
  paymentRestore: "Restaurar pagamento",
  paymentReopen: "Marcar como não pago",
  paymentPaidSuccess: "Pagamento confirmado",
  paymentAmountUpdated: "Valor do pagamento atualizado",
  paymentDueDateUpdated: "Data de vencimento atualizada",
  paymentCancelledSuccess: "Cobrança cancelada",
  paymentRestoredSuccess: "Pagamento restaurado",
  paymentActionFailed:
    "Não foi possível atualizar o pagamento. Atualize os dados e tente novamente.",
  paymentPaidTitle: "Confirmar pagamento",
  paymentPaidDescription:
    "Após a confirmação, o pagamento sai da fila de trabalho e vai para o histórico.",
  paymentAmountTitle: "Alterar valor do pagamento",
  paymentRefundTitle: "Fazer estorno",
  paymentRefundDescription:
    "O estorno reduz o valor recebido e devolve o saldo à fila de trabalho.",
  paymentAmountDescription:
    "Esta alteração afeta somente este pagamento e não muda o preço do plano.",
  paymentDueDateTitle: "Alterar vencimento do pagamento",
  paymentDueDateDescription:
    "A nova data se aplica somente a este pagamento. O motivo permanecerá no histórico de ações.",
  paymentCancelTitle: "Cancelar cobrança",
  paymentCancelDescription:
    "A cobrança permanecerá no histórico, mas o pagamento não será mais esperado da família.",
  paymentRestoreTitle: "Restaurar pagamento",
  paymentRestoreDescription:
    "O pagamento voltará à fila de trabalho como previsto ou vencido.",
  paymentCancelReason: "Motivo interno",
  paymentCancelReasonPlaceholder: "Por exemplo, o aluno parou de frequentar",
  paymentReasonRequired: "Informe um motivo interno.",
  paymentInvalidDueDate: "Informe uma nova data de vencimento válida.",
  paymentInvalidAmount: "Informe um valor válido igual ou maior que zero.",
  paymentConfirmPaid: "Confirmar pagamento",
  paymentConfirmAmount: "Salvar valor",
  paymentConfirmRefund: "Registrar estorno",
  paymentConfirmDueDate: "Alterar vencimento",
  paymentConfirmCancel: "Cancelar cobrança",
  paymentConfirmRestore: "Restaurar",
  paymentActionSummary: (child, amount, date) =>
    `${child} · ${amount} · vencimento ${date}`,
};
