...
import { ClientInboxSkeleton } from "./ClientInboxSkeleton";
...
export function ClientInboxScreen() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="min-h-0 flex-1 overflow-auto p-6" aria-busy={loading}>
        <SkeletonReveal
          loading={loading && !data}
          skeleton={<ClientInboxSkeleton />}
          contentClassName="space-y-5"
          data-testid="client-inbox-content"
        >
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              <option value="">
                {t("Все подключения", "All connections")}
              </option>
